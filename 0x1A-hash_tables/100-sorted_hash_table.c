...
/**
 * add_to_sorted_list - add node to sorted linked list
 * @table: sorted hashtable.
 * @node: the node toadd.
 *
 * Return: void
 */
...
/**
 * shash_table_get - retrieve value from the hashtable
 * @ht: hash table
 * @key: key to data
 *
...
/**
 * shash_table_delete - deletes sorted hash tables
